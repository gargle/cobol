...
(defvar cobol-debugging-statements
  "[ \t]+\\(DEBUG-CONTENTS\\|DEBUG-ITEM\\|DEBUG-LINE\\|DEBUG-NAME\\|DEBUG-SUB-1\\|DEBUG-SUB-2\\|DEBUG-SUB-3\\|DEBUGGING\\)")
...
"[ \t]+\\(END-\\(ADD\\|CALL\\|COMPUTE\\|DELETE\\|DIVIDE\\|EVALUATE\\|EXEC\\|IF\\|MULTIPLY\\|PERFORM\\|READ\\|RECEIVE\\|RETURN\\|REWRITE\\|SEARCH\\|START\\|STRING\\|SUBTRACT\\|UNSTRING\\|WRITE\\)\\)")
...
;  (message-box "current indent = %d" (current-indentation))
  (current-indentation))
;   (save-excursion
;     (beginning-of-line)
;     (cond ((looking-at comment-line-start-skip)
